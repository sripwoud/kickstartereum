...
class CampaignShow extends Component {
  ...
  renderCards() {
    const { minimumContribution, balance, requestCount, backersCount, funder } =
      this.props
    const items = [
      {
        header: funder,
        meta: 'Address of funder',
        description: 'Created this campaign and can create payment requests.',
      ...
      },
      {
        header: requestCount,
        meta: 'Requests',
        description: `Payment requests created by the funder.
